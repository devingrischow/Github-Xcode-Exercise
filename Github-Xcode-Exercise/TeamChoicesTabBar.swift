//
//  TeamChoicesTabBar.swift
//  Github-Xcode-Exercise
//
//  Created by Devin Grischow on 2/22/24.
//

import SwiftUI

struct TeamChoicesTabBar: View {
...
//
//                                }
                                xAxis = geometry.frame(in: .global).minX + 65
                            }
                            ...
                            Image(systemName: barItem.rawValue)
...
//This handles the creation of the Custom tab bar and how it moves from side to side. 
